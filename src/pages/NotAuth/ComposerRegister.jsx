...
import { HiUser, HiMicrophone, HiHome } from 'react-icons/hi';
import { RiAdminFill } from "react-icons/ri";


const ComposerRegister = () =>{
    ...
    function postData(e){
        ...
        axios.post('http://localhost:3002/registerComposer', composer).then(response => {
            navigate('/composer-lr');        
        })
        .catch(error => {
            console.log(error);
        });
            ...
            <div className="flex flex-col items-center justify-center min-h-screen">
                <div className="w-full p-6 m-auto bg-transparent  lg:max-w-xl mt-10 ml-96">
                    ...
                    <div className="flex mt-4 gap-x-2">
                        ...
                        <button className="flex items-center justify-center w-full p-2 border rounded-md text-sm font-medium text-blue-400 hover:text-
                        cyan 400">
...
export default ComposerRegister;